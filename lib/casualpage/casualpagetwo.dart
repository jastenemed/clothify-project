import 'package:clothify/casualpage/casualchecktwo.dart';
...
class Casualtwo extends StatelessWidget {
  const Casualtwo({super.key});
                ...
                GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Caschecktwo()));
                    },
                    child: const Buybttn()),
              ],
            ),
