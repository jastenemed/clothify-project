...
import 'package:clothify/formalpage/formalcheckthree.dart';
import 'package:flutter/material.dart';

class Formalthree extends StatelessWidget {
  const Formalthree({super.key});
                ...
                GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Formalcheckthree()));
                    },
                    child: const Buybttn()),
              ],
            ),
