...
import 'package:clothify/hoodypage/hoodcheckthree.dart';
import 'package:flutter/material.dart';

class Hoodpagethree extends StatelessWidget {
  const Hoodpagethree({super.key});
                ...
                GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Hoodcheckthree()));
                    },
                    child: const Buybttn()),
              ],
            ),
