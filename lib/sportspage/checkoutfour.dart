...
class Checkoutfour extends StatelessWidget {
  const Checkoutfour({super.key});
          ...
          leading: IconButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const Sportfour()));
            },
          ...
          child: SafeArea(
            ...
            child: Column(
              children: [
                ...
                const Producttile(imagePath: 'assets/images/sportfour.png'),
